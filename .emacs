...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window lsp-mode helm-gtags crux smartparens doom-themes cmake-mode company-c-headers astyle format-all clang-format+ clang-format blacken python-black auctex ## ac-c-headers auto-complete))
 '(show-paren-mode t))
